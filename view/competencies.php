    ...
    <div id="sub-comp-assessment" class="sub-panel sub-panel-comp space-y-6">
        ...
        <div class="flex items-center justify-between flex-wrap gap-3 p-4 bg-white rounded-2xl border border-[#E8DEDC] shadow-2xs">
            <div class="flex items-center space-x-2">
                ...
                <span id="comp-assessment-header-name" class="font-heading font-bold text-xs bg-primary-50 text-primary border border-primary-100 px-3 py-1 rounded-xl">Associate</span>
            </div>
            <div id="comp-switch-associate-container" class="flex items-center space-x-2">
